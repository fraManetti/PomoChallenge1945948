<?php 
    ...
    $query = "select keyhash, title, pomodori, note, dat,tim from endedtask where endedtask.username = '{$cookie}' and date_trunc('week', to_date(dat, 'DD-MM-YYYY')) = date_trunc('week', to_date('{$myvarValue}', 'DD-MM-YYYY'))::date";
